...
case 'Restore'
            set(Fig.Parameter1,'String',1);
            set(Fig.Parameter2,'String',1);
            set(Fig.Parameter3,'String',120);
            set(Fig.Parameter4,'String',5);
            set(Fig.Parameter5,'String',110);
            set(Fig.Parameter6,'String',-20);
            set(Fig.Parameter7,'String',2500);
            set(Fig.Parameter8,'String',2500);
...
% save PDefaults PDefaults COMMENTED OUT 10/25/2011 by SP
...
%         xdata=[1:length(averagedata)];
%         x=lsqcurvefit(@myfun, [7 120 -36.5 -20.3 -3 -760 -7 -.5],xdata, averagedata);
% %         trace1=x(1)*sin(2*pi*x(2)/1000*xdata+x(3))+x(4)+x(5)*sin(2*pi*x(6)/1000*xdata+x(7))+x(8)*xdata;
%         trace1=x(1)*sin(2*pi*x(2)/1000*xdata+x(3))+x(4)+x(5)*sin(2*pi*x(6)/1000*xdata+x(7));
%         averagedata=averagedata-trace1;
%         averagedata=averagedata-min(averagedata);
