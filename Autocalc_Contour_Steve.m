...
action = varargin{1} % DON'T CHANGE
global Log Contour Autocalc Stripchart % DON'T CHANGE
...
case 'Change' % IGNORE/DELETE
   set(Autocalc.Button.Apply,'Enable','on');  
   
   
case 'Apply' %SLIM UP AND FIX.
   warning off
    figure(Contour.Figure)% DON'T CHANGE

   if Autocalc.Applied==0;% DON'T CHANGE
      Autocalc.Applied=1;% DON'T CHANGE
      point=0;% DON'T CHANGE
      count=1;% DON'T CHANGE
      Autocalc.Member.Distance=0*ones(1,length(Contour.Vector.Y));% DON'T CHANGE
      Autocalc.Member.Angle=0*ones(1,length(Contour.Vector.Y));% DON'T CHANGE
   Contour.Base.Distance=sqrt(Contour.Vector.Y.^2+Contour.Vector.X.^2);% DON'T CHANGE
   Contour.Base.Angle=atan2(Contour.Vector.Y,Contour.Vector.X); % DON'T CHANGE
   Contour.Vector.Magnitude=sqrt((Contour.Vector.X-Contour.Vector.Vx).^2+(Contour.Vector.Y-Contour.Vector.Vy).^2); % DON'T CHANGE
   Contour.Vector.Angle=(atan2(-Contour.Vector.Vy,Contour.Vector.Vx));% DON'T CHANGE
   
   Autocalc.arc=str2num(get(Autocalc.Edit.Arc,'String'))/2;% DON'T CHANGE
   Autocalc.angle=str2num(get(Autocalc.Edit.Angle,'String'));% DON'T CHANGE
   Autocalc.lowangle=(Autocalc.angle-Autocalc.arc)*pi/180;% DON'T CHANGE
   Autocalc.highangle=(Autocalc.angle+Autocalc.arc)*pi/180;% DON'T CHANGE
 ...
 %%%%%%%%%%%%%%%%% THIS NEEDS TO BE REWRITTEN/ EXPANDED %%%%%%%%%%%%%%%%%%%%%%%
case 'All Angles'
   counter=1;
   ...
   new(:,2)=meanmag;
   save junk new
   text(-2,0,num2str(new))
   pp=[0:20:360;meanmag']'

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
case 'Zeng'   %IGNORE/DELETE
   Temp=varargin{2};
