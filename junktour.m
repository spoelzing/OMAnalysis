...
case 'Init'
   Contour.Figurej=figure;
            
            set(Contour.Figurej,'Units','pixels', ...
               'Name','junktour',...
            	'menu','none',...
               'NumberTitle','off',...
               'unit','pixel',...     
            ...
            Contour.Text.Tmin = uicontrol('Parent',Contour.Figurej, ...
            ...
            Contour.Text.Tmax = uicontrol('Parent',Contour.Figurej, ...
               'BackgroundColor',[0.8 0.8 0.8], ...
               'enable','on',...
               'ListboxTop',0, ...          
               'Units','pixel',...   
            ...
            Contour.Text.Ctop = uicontrol('Parent',Contour.Figurej, ...
               'BackgroundColor',[0.8 0.8 0.8], ...
               'enable','on',...
               'ListboxTop',0, ...           
               'Units','pixel',...   
            ...
            Contour.Text.Cbottom = uicontrol('Parent',Contour.Figurej, ...
               'BackgroundColor',[0.8 0.8 0.8], ...
               'enable','on',...
               'ListboxTop',0, ...          
               'Units','pixel',...   
               ...
               'Style','text', ...
               'Tag','Time Type');
            Contour.Text.Interval = uicontrol('Parent',Contour.Figurej, ...
               'BackgroundColor',[0.8 0.8 0.8], ...
               'enable','on',...
               'ListboxTop',0, ...              
               'Units','pixel',...   
            ...
            Contour.Edit.Ctop = uicontrol('Parent',Contour.Figurej, ...
            ...
            Contour.Edit.Cbottom = uicontrol('Parent',Contour.Figurej, ...      
               'Units','pixel',...   
               'enable','on',...
               'BackgroundColor',[1 1 1], ...
               'ListboxTop',0, ...
            ...
            Contour.Edit.Interval = uicontrol('Parent',Contour.Figurej, ...   
               'Units','pixel',...   
               'BackgroundColor',[1 1 1], ...
               'enable','on',...
               'ListboxTop',0, ...
            ...
            Contour.Text.Interp = uicontrol('Parent',Contour.Figurej, ...
               'BackgroundColor',[0.8 0.8 0.8], ...
               'enable','on',...
               'ListboxTop',0, ...              
               'Units','pixel',...   
               ...
               'Style','text', ...
               'Tag','Time Type');
           Contour.Pop.Interp = uicontrol('Parent',Contour.Figurej, ...
				   'Units','pixel', ...
				   'BackgroundColor',[1 1 1],...
               'enable','on',...
				   'HorizontalAlignment','right',...
            ...
            Contour.Text.Method = uicontrol('Parent',Contour.Figurej, ...
               'BackgroundColor',[0.8 0.8 0.8], ...
               'enable','on',...
               'ListboxTop',0, ...              
               'Units','pixel',...   
               ...
               'Style','text', ...
               'Tag','Time Type');
            Contour.Pop.Method = uicontrol('Parent',Contour.Figurej, ...
				   'Units','pixel', ...
				   'BackgroundColor',[1 1 1],...
               'enable','on',...
				   'HorizontalAlignment','right',...
             ...
             Contour.Check.Label = uicontrol('Parent',Contour.Figurej, ...
               'BackgroundColor',[0.8 0.8 0.8], ...
               'enable','on',...
               'ListboxTop',0, ...              
               'Units','pixel',...   
            ...
            Temp=makemenu(Contour.Figurej,char(Temp.File(:,1)),char(Temp.File(:,2)), char(Temp.File(:,3)));
...
case 'Apply'
   %  MATLAB M-file to plot a contour map from an XYZ annotation file
	...
	Min=min(min(bsteve));
	Max=max(max(bsteve));
    lowv=str2num(get(Contour.Edit.Cbottom,'string'));
    a=find(bsteve<lowv);
    bsteve(a)=NaN;
   v=(Min:interval:Max);
   subplot('position',[.2 .4 .55 .55]),
  contourf(flipud(bsteve),v) 
...
case 'Export'
   [Filename Path]=uiputfile(['c:\*.' varargin{2}],'Select a file for your waveform');
